...
Any function that maps arbitrarily large data to a fixed size
...
---
# WebCrypto 🔐
Browser API for creating & using keys

Offers **RSA**, **AES**, and **ECC** (only NIST curves)
...
But someone with permissions can sign an additional token with some **subset of those permissions**
